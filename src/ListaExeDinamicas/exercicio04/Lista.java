...
public class Lista {
    ...
    public boolean insere(Object[] itens, Object ch) {
        if (vazia() || itens == null || ch == null) {
            return false;}
        Celula pivo = this.primeiro.prox;
        while (pivo != null && !pivo.item.equals(ch)) {
            pivo = pivo.prox;
        }
        if (pivo == null) {
            return false;
